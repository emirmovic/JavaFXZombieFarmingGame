...
public class FarmController {
                ...
                for (Plot[] plots : farmPlots) {
                    for (Plot plot : plots) {
                        ...
                        if (!plot.updateWater(false)) {
                            alivePlots.remove(plot.getRow() * 4 + plot.getCol());
                        }
    ...
    private void updateGrowth(Plot plot, String coordinates, Pane pane) {
        ...
        if (!plant.contains("grown") && !plant.contains("ancient")) {
            ...
            alivePlots.remove((Integer.parseInt(coordinates.substring(0, 1)) * 4
        ...
        if (inventory[3][2] > 0) {
            ...
            if (farmPlots[row][col].getOccupied()) {
                ...
                if (row == 0) {
                    ...
                    plotNumber = row + col + 4;
                } else {
                    plotNumber = row + col + 7;
                }
            ...
            if (farmPlots[row][col].isAlive() && !farmPlots[row][col].getPotion()
                ...
                if (!plotInfo[0].contains("seed")) {
                    ...
                    if (actualGrowth.contains("Corn")) {
                        plantCorn(
                                clickedPane, plotInfo[1], actualGrowth.split("C")[0],
                                cornPaths[potionIndex], true);
                    } else if (actualGrowth.contains("Broccoli")) {
                        plantBroccoli(
                                clickedPane, plotInfo[1], actualGrowth.split("B")[0],
    ...
    private void plantSeedCorn(Pane clickedPane, String plotCoor) {
        ...
        if (clickedPane.getId().contains("emptyPlot") && cornSeeds != 0) {
            ...
            plotGrid.setMinWidth(180.0);
            plotGrid.setTranslateX(10);
            plotGrid.setTranslateY(10);
            plotGrid.getColumnConstraints().add(new ColumnConstraints(100));
     ...
     */
    private void plantCorn(Pane plot,
                           String plotCoor,
                           String growth,
                           String imagePath,
                           boolean addPotion) {
        ...
        plotGrid.setPrefWidth(180.0);
        plotGrid.getColumnConstraints().add(new ColumnConstraints(90.0));
     ...
     * @param addPotion is whether to add a potion graphic to the plot
     */
    private void plantBroccoli(Pane plot,
                               String plotCoor,
                               String growth,
                               String imagePath,
                               boolean addPotion) {
        ...
        plotGrid.setPrefHeight(180.0);
        plotGrid.setPrefWidth(180.0);
        plotGrid.getColumnConstraints().add(new ColumnConstraints(90));
        plotGrid.getRowConstraints().add(new RowConstraints(90.0));
        plotGrid.setStyle("-fx-background-color: Saddlebrown;");
        ...
        broccoliView.setFitHeight(55.0);
    ...
    private void plantCarrot(
        ...
        plotGrid.setPrefHeight(180.0);
        plotGrid.setPrefWidth(180.0);
        plotGrid.getColumnConstraints().add(new ColumnConstraints(60.0));
        plotGrid.getRowConstraints().add(new RowConstraints(60.0));
        plotGrid.setStyle("-fx-background-color: Saddlebrown;");
    ...
    private void plantBabyBomb(Pane plot, String plotCoor) {
        ...
        plotGrid.setTranslateX(10);
        plotGrid.setTranslateY(10);
        plotGrid.getColumnConstraints().add(new ColumnConstraints(66));
        plotGrid.getRowConstraints().add(new RowConstraints(66));
        plotGrid.setStyle("-fx-background-color: Saddlebrown;");

        plot.setId("babyBomb:" + plotCoor);
        plotGrid.setId("grid:" + plotCoor);
    ...
    private void plantGrownBomb(Pane plot, String plotCoor) {
        ...
        plotGrid.setTranslateX(10);
        plotGrid.setTranslateY(10);
        plotGrid.getColumnConstraints().add(new ColumnConstraints(60));
        plotGrid.getRowConstraints().add(new RowConstraints(60));
        plotGrid.setStyle("-fx-background-color: Saddlebrown;");
                ...
                for (Plot p : plotRow) {
                    for (int i = 0; i < randAmount; i++) {
                        if (!p.updateWater(false)) {
                            alivePlots.remove((p.getRow() * 4 + p.getCol()));
                        }
                    }
                }
            }
