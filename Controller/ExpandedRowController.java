...
public class ExpandedRowController {
    @FXML
    ...
    private void handleRandomPlanting() {
        ...
        randomPlanting(plot30, "30");
        randomPlanting(plot31, "31");
        randomPlanting(plot32, "32");
        randomPlanting(plot33, "33");
        randomPlanting(plot34, "34");
    }
    ...
    private void handleSetPlant() {
        ...
        setPlant(plot30, farmPlots[3][0].getPlant(), "30", farmPlots[3][0].getPotion());
        setPlant(plot31, farmPlots[3][1].getPlant(), "31", farmPlots[3][1].getPotion());
        setPlant(plot32, farmPlots[3][2].getPlant(), "32", farmPlots[3][2].getPotion());
        setPlant(plot33, farmPlots[3][3].getPlant(), "33", farmPlots[3][3].getPotion());
        setPlant(plot34, farmPlots[3][4].getPlant(), "34", farmPlots[3][4].getPotion());
    }
                        ...
                        for (Plot plot : plots) {
                            if (plot.isAlive()) {
                                ...
                                case "24":
                                    ...
                                    break;
                                case "30":
                                    updateGrowth(plot, coordinates, plot30);
                                    break;
                                case "31":
                                    updateGrowth(plot, coordinates, plot31);
                                    break;
                                case "32":
                                    updateGrowth(plot, coordinates, plot32);
                                    break;
                                case "33":
                                    updateGrowth(plot, coordinates, plot33);
                                    break;
                                case "34":
                                    updateGrowth(plot, coordinates, plot34);
                                    break;
                                default:
                                    return;
                                }
    ...
    private void plantSeedCorn(Pane clickedPane, String plotCoor) {
        ...
        if (clickedPane.getId().contains("emptyPlot") && cornSeeds != 0) {
            ...
            plotGrid.getRowConstraints().add(new RowConstraints(65));
    ...
    private void plantBabyBomb(Pane plot, String plotCoor) {
        ...
        view.setFitHeight(120.0);
        view.setTranslateX(5.0);
        view.setTranslateY(40.0);
    ...
    private void plantGrownBomb(Pane plot, String plotCoor) {
        ...
        view.setFitWidth(130.0);
        view.setTranslateY(35.0);
        view.setPreserveRatio(true);
    ...
    public boolean chanceRain() {
        ...
        int rainMultiplier = (int) (Math.random() * 3) + 1;
